...
import type {
  IAutomation,
  IAutomationInterface,
} from "../../../contracts/interfaces/IAutomation";
...
export class IAutomation__factory {
  ...
  static createInterface(): IAutomationInterface {
    return new utils.Interface(_abi) as IAutomationInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IAutomation {
    return new Contract(address, _abi, signerOrProvider) as IAutomation;
  }
}
