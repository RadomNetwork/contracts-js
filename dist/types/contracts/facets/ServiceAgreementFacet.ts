...
export interface ServiceAgreementFacetInterface extends utils.Interface {
  functions: {
    "_getAgreementPricingSelection(uint64)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "_getAgreementPricingSelection",
...
export interface ServiceAgreementFacet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ServiceAgreementFacetInterface;
  ...
  functions: {
    ...
    ): Promise<[Services.PricingSelectionStructOutput[]]>;
