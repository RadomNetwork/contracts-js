...
export interface IRadomRegistryDiamondInterface extends utils.Interface {
  functions: {
...
export interface IRadomRegistryDiamond extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IRadomRegistryDiamondInterface;
