...
export interface RadomERC20TokenInterface extends utils.Interface {
  functions: {
...
export interface RadomERC20Token extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RadomERC20TokenInterface;
  ...
  callStatic: {
    ...
    sellToken(_amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
